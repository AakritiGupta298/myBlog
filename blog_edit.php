...
<html lang="en">
  ...
  <body>
    ...
    <div class="myblog">
         ...
         <p style="background-color: #8e0000; font-family: 'Pacifico', cursive; font-size: 80px; display: flex;justify-content: center; color: white;"> Edit Profile </p>
  ...
  <div class="form-group">
    ...
    <input type="education" class="form-control" id="exampleInputPassword1" name="signup_education" placeholder="Education">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1"><strong>Profession</strong></label>
    <input type="profession" class="form-control" id="exampleInputPassword1" name="signup_profession" placeholder="Profession">
  </div>
  <div class="form-group">
